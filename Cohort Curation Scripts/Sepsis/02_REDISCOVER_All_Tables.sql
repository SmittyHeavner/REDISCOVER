...
been filtered down to only include people and records related to the REDISCOVER-ICU registry.

Description:
Creates REDISCOVER tables from the generated REDISCOVER cohort.
...
DROP TABLE IF EXISTS [Results].[REDISCOVER_Person];
DROP TABLE IF EXISTS [Results].[REDISCOVER_Measurement];
DROP TABLE IF EXISTS [Results].[REDISCOVER_Drug_Exposure];
DROP TABLE IF EXISTS [Results].[REDISCOVER_Death];
DROP TABLE IF EXISTS [Results].[REDISCOVER_Observation];
DROP TABLE IF EXISTS [Results].[REDISCOVER_Procedure_Occurrence];
DROP TABLE IF EXISTS [Results].[REDISCOVER_Condition_Occurrence];
DROP TABLE IF EXISTS [Results].[REDISCOVER_Visit_Occurrence];
DROP TABLE IF EXISTS [Results].[REDISCOVER_Device_Exposure];
...
INTO [Results].[REDISCOVER_Person]
FROM person AS pe
INNER JOIN [Results].[REDISCOVER_Cohort] AS coh
...
INTO [Results].[REDISCOVER_Measurement]
...
INNER JOIN [Results].[REDISCOVER_concepts]
...
WHERE
    ...
    AND ([Results].[REDISCOVER_concepts]include_descendants = 'TRUE' OR CONCEPT_ANCESTOR.ancestor_concept_id = CONCEPT_ANCESTOR.descendant_concept_id)
...
INTO [Results].[REDISCOVER_Drug_exposure]
...
INTO [Results].[REDISCOVER_Observation]
...
INNER JOIN [Results].[REDISCOVER_concepts]
    ON CONCEPT_ANCESTOR.ancestor_concept_id = [Results].[REDISCOVER_concepts].concept_id
WHERE
    [Results].[REDISCOVER_concepts].domain = 'Observation'
    AND ([Results].[REDISCOVER_concepts].include_descendants = 'TRUE' OR CONCEPT_ANCESTOR.ancestor_concept_id = CONCEPT_ANCESTOR.descendant_concept_id)
...
INTO [Results].[REDISCOVER_Procedure_Occurrence]
...
INNER JOIN [Results].[REDISCOVER_concepts]
    ON CONCEPT_ANCESTOR.ancestor_concept_id = [Results].[REDISCOVER_concepts].concept_id
WHERE
    [Results].[REDISCOVER_concepts].domain = 'Procedure'
    AND ([Results].[REDISCOVER_concepts].include_descendants = 'TRUE' OR CONCEPT_ANCESTOR.ancestor_concept_id = CONCEPT_ANCESTOR.descendant_concept_id)
...
INTO [Results].[REDISCOVER_Condition_Occurrence]
...
INNER JOIN [Results].[REDISCOVER_concepts]
    ON CONCEPT_ANCESTOR.ancestor_concept_id = [Results].[REDISCOVER_concepts].concept_id
WHERE
    [Results].[REDISCOVER_concepts].domain = 'Condition'
    AND ([Results].[REDISCOVER_concepts].include_descendants = 'TRUE' OR CONCEPT_ANCESTOR.ancestor_concept_id = CONCEPT_ANCESTOR.descendant_concept_id)
...
INTO [Results].[REDISCOVER_Visit_Occurrence]
...
INTO [Results].[REDISCOVER_Device_Exposure]
...
INNER JOIN [Results].[REDISCOVER_concepts]
    ON CONCEPT_ANCESTOR.ancestor_concept_id = [Results].[REDISCOVER_concepts].concept_id
WHERE
    [Results].[REDISCOVER_concepts].domain = 'Device'
    AND ([Results].[REDISCOVER_concepts].include_descendants = 'TRUE' OR CONCEPT_ANCESTOR.ancestor_concept_id = CONCEPT_ANCESTOR.descendant_concept_id)
