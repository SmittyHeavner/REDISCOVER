...
DROP TABLE IF EXISTS Results.REDISCOVER_Condition_Occurrence_Rare_Removed
...
FROM Results.REDISCOVER_Condition_Occurrence AS cond
...
INTO Results.REDISCOVER_Condition_Occurrence_Rare_Removed
FROM Results.REDISCOVER_Condition_Occurrence AS c
