...
DROP TABLE IF EXISTS [Results].[deident_REDISCOVER_condition_occurrence];
DROP TABLE IF EXISTS [Results].[deident_REDISCOVER_death];
DROP TABLE IF EXISTS [Results].[deident_REDISCOVER_drug_exposure];
DROP TABLE IF EXISTS [Results].[deident_REDISCOVER_device_exposure];
DROP TABLE IF EXISTS [Results].[deident_REDISCOVER_measurement];
DROP TABLE IF EXISTS [Results].[deident_REDISCOVER_observation];
DROP TABLE IF EXISTS [Results].[deident_REDISCOVER_person];
DROP TABLE IF EXISTS [Results].[deident_REDISCOVER_procedure_occurrence];
DROP TABLE IF EXISTS [Results].[deident_REDISCOVER_visit_occurrence];
...
CREATE TABLE Results.deident_REDISCOVER_person (
...
--HINT DISTRIBUTE_ON_KEY(person_id)
CREATE TABLE Results.deident_REDISCOVER_death (
    person_id INTEGER NOT NULL,
...
--HINT DISTRIBUTE_ON_KEY(person_id)
CREATE TABLE Results.deident_REDISCOVER_visit_occurrence
(
...
--HINT DISTRIBUTE_ON_KEY(person_id)
CREATE TABLE Results.deident_REDISCOVER_procedure_occurrence (
...
--HINT DISTRIBUTE_ON_KEY(person_id)
CREATE TABLE Results.deident_REDISCOVER_drug_exposure (
...
--HINT DISTRIBUTE_ON_KEY(person_id)
CREATE TABLE Results.deident_REDISCOVER_device_exposure (
...
--HINT DISTRIBUTE_ON_KEY(person_id)
CREATE TABLE Results.deident_REDISCOVER_condition_occurrence (
...
--HINT DISTRIBUTE_ON_KEY(person_id)
CREATE TABLE Results.deident_REDISCOVER_measurement (
...
--HINT DISTRIBUTE_ON_KEY(person_id)
CREATE TABLE Results.deident_REDISCOVER_observation (
