...
FROM [Results].[deident_REDISCOVER_death];
...
FROM [Results].[deident_REDISCOVER_observation]
...
SELECT
    ...
    COUNT(DISTINCT person_id) AS [Num People],
    COUNT(*) AS [Num Records]
FROM [Results].[deident_REDISCOVER_procedure_occurrence]
...
SELECT
    ...
    COUNT(DISTINCT person_id) AS [Num People],
    COUNT(*) AS [Num Records]
FROM [Results].[deident_REDISCOVER_condition_occurrence]
...
SELECT
    ...
    COUNT(DISTINCT person_id) AS [Num People],
    COUNT(*) AS [Num Records]
FROM [Results].[deident_REDISCOVER_measurement]
...
SELECT
    ...
    COUNT(DISTINCT person_id) AS [Num People],
    COUNT(*) AS [Num Records]
FROM [Results].[deident_REDISCOVER_device_exposure]
...
SELECT
    ...
    COUNT(DISTINCT person_id) AS [Num People],
    COUNT(*) AS [Num Records]
FROM [Results].[deident_REDISCOVER_drug_exposure]
